...
import { ErrorCollection, ResponseModel, SiteNavs } from '../../../models';
...
export class SiteNavFormComponent implements OnInit {
    ...
    @Select('dropdowns', 'moduleNames') module$: Observable<DropdownModel[]>;
    @Select('dropdowns', 'routeTypes') routeType$: Observable<DropdownModel[]>;
    @Select('dropdowns', 'routeAreas') areaName$: Observable<DropdownModel[]>;

    parentNavs: DropdownModel[] = [];
    menuFor: string = 'parent';
