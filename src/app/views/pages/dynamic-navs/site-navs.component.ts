...
import { Filter, QueryModel, ResponseModel, SiteNavs } from '../../../models';
import { collectionInOut, CustomAnimationPlayer, ExtendedMatDialog, fadeIn, ParamGenService } from '../../../utils';
import { AlertType, AlertTypeClass, DeleteConfirmComponent, SnackbarModel, SnackToastService } from '../shared';
...
export class SiteNavsComponent implements AfterViewInit, OnDestroy {
    ...
    dataSource: MatTableDataSource<SiteNavs> = new MatTableDataSource(null);
    @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
    @ViewChild(MatSort) sort: MatSort;
    selection = new SelectionModel<SiteNavs>(true, []);
    ...
    trackById = (_: number, item: SiteNavs) => item.id;
    ...
    onAction(id: number) {
        ...
        instance.afterClosed().pipe(
            ...
            tap(res => {
                ...
                const d: SiteNavs = res.contentBody;
